...
namespace CppCLRWinFormsProject {
  ...
  public:
    Form1(void)
    {
      ...
      cboxScanIntTimeExtR->Items->Add(600);
      ...
      cboxScanIntTimeExtG->Items->Add(600);
      ...
      cboxScanIntTimeExtB->Items->Add(600);
      ...
      cboxScanIntTimeScaR->Items->Add(600);
      cboxScanIntTimeScaR->SelectedItem = 600;
      ...
      cboxScanIntTimeScaG->Items->Add(600);
      cboxScanIntTimeScaG->SelectedItem = 600;
      ...
      cboxScanIntTimeScaB->Items->Add(600);
      cboxScanIntTimeScaB->SelectedItem = 600;
      ...
      cboxManualIntTimeExt->Items->Add(600);
      ...
      cboxManualIntTimeSca->Items->Add(600);
      cboxManualIntTimeSca->SelectedItem = 600;
